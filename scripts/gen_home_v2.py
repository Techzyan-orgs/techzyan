...
home_code += """
        ...
        {/* 4. DEDICATED DURGA PUJA SPOTLIGHT */}
        <section className="py-16 lg:py-24 bg-gradient-to-b from-[#0F0C08] to-[#080C14] border-t border-b border-amber-950/40">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="p-8 sm:p-12 lg:p-14 rounded-3xl bg-gradient-to-br from-[#1C140A] via-[#140E06] to-[#0D0A05] border border-amber-500/30 shadow-2xl relative overflow-hidden">
...
print("Homepage written successfully!")
