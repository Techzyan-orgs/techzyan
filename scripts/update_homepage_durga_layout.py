          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="rounded-3xl bg-gradient-to-br from-[#1C140A] via-[#140E06] to-[#0D0A05] border border-amber-500/30 p-8 sm:p-12 lg:p-14 overflow-hidden shadow-2xl relative">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
                ...
                {/* Right Column: Backgroundless Durga Idol Artwork in Empty Space (5 cols) */}
                <div className="lg:col-span-5 flex items-center justify-center pt-6 lg:pt-0">
                  <div className="relative w-full max-w-[340px] aspect-square flex items-center justify-center">
                    ...
                    {/* Backgroundless Durga Idol Vector / PNG Artwork */}
                    <div className="relative z-10 w-full h-full flex items-center justify-center p-2">
                      <Image
                        src="/images/durga-idol.svg"
                        alt="Durga Idol Traditional Motif"
                        width={320}
                        height={320}
                        className="object-contain drop-shadow-[0_10px_35px_rgba(245,158,11,0.35)] hover:scale-105 transition-transform duration-500"
                        priority
                      />
                    </div>
                  </div>
...
print("Homepage with 2-column Durga idol layout updated!")
