...
home_code += """
        ...
        {/* 4. DEDICATED DURGA PUJA SPOTLIGHT WITH RICH FESTIVAL PHOTOGRAPHY */}
        <section className="py-16 lg:py-24 bg-gradient-to-b from-[#0F0C08] to-[#080C14] border-t border-b border-amber-950/40">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="rounded-3xl border border-amber-500/40 shadow-2xl overflow-hidden relative">
              {/* Background Photography with Gradient Mask */}
              <div className="absolute inset-0 z-0">
                <Image
                  src="https://images.unsplash.com/photo-1601058268499-e52658b8bb88?auto=format&fit=crop&w=1600&q=85"
                  alt="Durga Puja Pandal Art and Illumination"
                  fill
                  className="object-cover object-center opacity-30"
                  sizes="(max-width: 1200px) 100vw, 1200px"
                  priority
                />
                <div className="absolute inset-0 bg-gradient-to-r from-[#0C0804]/95 via-[#120B05]/90 to-[#0A0704]/98" />
              </div>

              <div className="relative z-10 p-8 sm:p-12 lg:p-14 max-w-3xl space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                  <div className="p-3 rounded-xl bg-black/60 border border-amber-500/20 text-xs text-slate-200 flex items-start gap-2 backdrop-blur-sm">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-3.5 pt-4">
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 bg-black/70 hover:bg-black/90 text-amber-300 border border-amber-500/40 text-xs font-bold uppercase tracking-wider rounded-xl transition-colors backdrop-blur-sm"
                  >
        ...
        {/* 5. DEMONSTRATIONS SHOWCASE WITH VISUAL THUMBNAILS */}
...
print("Homepage with imagery written successfully!")
